...
// ── MascotMonoIcon — mascotmono.svg inlined with themeable fill ──────────────
function MascotMonoIcon({ width = 40, height = 40, color }) {
  const c = color || T.accent;
  return (
    <svg width={width} height={height} viewBox="0 0 500 500" xmlns="http://www.w3.org/2000/svg" style={{ color: c }}>
      ...
      <path d="M0 0 C0.66 0.66 1.32 1.32 2 2 C1.34 2 0.68 2 0 2 C0 1.34 0 0.68 0 0 Z " fill="currentColor" transform="translate(357,103)"/>
    </svg>
  );
}
