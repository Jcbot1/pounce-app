    ...
    <>
      ...
      <div style={{ position: "fixed", bottom: "1.5rem", right: "1.5rem", zIndex: 100, display: "flex", alignItems: "center" }}>
        <span aria-hidden="true" style={{
          ...
          fontFamily: FF_SANS, fontSize: "0.9rem", fontWeight: 500, color: T.text,
          width: fabExpanded ? "142px" : "0px",
          marginRight: fabExpanded ? "0.5rem" : "0px",
          paddingLeft: fabExpanded ? "1.1rem" : "0px",
          paddingRight: fabExpanded ? "1.1rem" : "0px",
