...
function AnswerButton({ onClick, children, bg, border, color, shadow, submitted, label, style: extraStyle }) {
  return (
...
function PounceLogo({ height = 28, theme, stacked = false }) {
  ...
  return (
    <div style={{ display: "flex", flexDirection: stacked ? "column" : "row", alignItems: "center", gap: stacked ? "0.5rem" : "0.4rem" }}>
      <svg width={iconSize} height={iconSize} viewBox="0 0 24 24" fill="none" stroke={t.accent} strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" xmlns="http://www.w3.org/2000/svg">
...
function Mochi({ size = 100 }) {
  return (
    <svg width={size} height={size} viewBox="0 0 24 24" fill="none" stroke={T.accent} strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round">
      <path stroke="none" d="M0 0h24v24H0z" fill="none"/>
      <path d="M20 3v10a8 8 0 1 1 -16 0v-10l3.432 3.432a7.963 7.963 0 0 1 4.568 -1.432c1.769 0 3.403 .574 4.728 1.546l3.272 -3.546"/>
      <path d="M2 16h5l-4 4"/><path d="M22 16h-5l4 4"/>
      <path d="M11 16a1 1 0 1 0 2 0a1 1 0 1 0 -2 0"/>
      ...
      <path d="M88 95 Q108 100 105 80 Q102 65 92 72" stroke="#c8783a" strokeWidth="7" strokeLinecap="round" fill="none"/>
...
const btn = (variant = "primary", small = false) => ({
  ...
  ...(variant === "primary"  && { background: "linear-gradient(" + T.surface + ", " + T.surface + ") padding-box, linear-gradient(135deg, " + T.accent + " 0%, " + T.gradient2 + " 100%) border-box", border: "2px solid transparent", color: T.muted2 }),
  ...(variant === "purple"   && { background: "linear-gradient(" + T.surface + ", " + T.surface + ") padding-box, linear-gradient(135deg, " + T.accent + " 0%, " + T.gradient2 + " 100%) border-box", border: "2px solid transparent", color: T.muted2 }),
  ...
  return (
    <>
      ...
      <div style={{
        ...
        background: T.mode === "light" ? "rgba(255,255,255,0.88)" : "rgba(255,255,255,0.1)",
...
function ResultsChips({ isHist, hasMissed, onRetry, onRetryMissed, onExport, onStudySet }) {
  ...
  return (
    <div ref={ref}
      ...
      <style>{"div::-webkit-scrollbar { display: none; }"}</style>
      {!isHist && (
        <GhostButton onClick={onRetry} small style={{ height: "44px", paddingLeft: "1rem", paddingRight: "1rem", display: "flex", alignItems: "center", gap: "0.4rem", whiteSpace: "nowrap", flexShrink: 0 }}>
      ...
      {isHist && onStudySet && (
        <GhostButton onClick={onStudySet} small style={{ height: "44px", paddingLeft: "1rem", paddingRight: "1rem", display: "flex", alignItems: "center", gap: "0.4rem", whiteSpace: "nowrap", flexShrink: 0, fontFamily: "'DM Sans', sans-serif" }}>
          <svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2.2" strokeLinecap="round" strokeLinejoin="round">
      ...
      {hasMissed && (
        <GhostButton onClick={onRetryMissed} small style={{ height: "44px", paddingLeft: "1rem", paddingRight: "1rem", display: "flex", alignItems: "center", gap: "0.4rem", whiteSpace: "nowrap", flexShrink: 0 }}>
          <svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2.2" strokeLinecap="round" strokeLinejoin="round">
            <circle cx="12" cy="12" r="10"/><line x1="15" y1="9" x2="9" y2="15"/><line x1="9" y1="9" x2="15" y2="15"/>
          </svg>
          Retry missed
      ...
      <GhostButton onClick={onExport} small style={{ height: "44px", paddingLeft: "1rem", paddingRight: "0.85rem", display: "flex", alignItems: "center", gap: "0.4rem", whiteSpace: "nowrap", flexShrink: 0, fontFamily: "'DM Sans', sans-serif" }}>
        <svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2.2" strokeLinecap="round" strokeLinejoin="round">
          <path d="M21 15v4a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2v-4"/><polyline points="17 8 12 3 7 8"/><line x1="12" y1="3" x2="12" y2="15"/>
        </svg>
        Export
    ...
    <div style={{ background: T.mode === "light"
      ...
      <div style={{ minHeight: "100vh", background: "transparent", visibility: (showDeleteAnim || showWelcome) ? "hidden" : "visible",
        ...
        <div style={{
          ...
          display: "flex", flexDirection: "column",
          ...(showSidebar ? { borderBottom: "1px solid " + T.border } : {}),
        }}>
                  ...
                  <div style={{ position: "relative", flexShrink: 0 }}>
                    {resultsFilter !== "all" ? (
                      <div style={{ borderRadius: "99px", padding: "2px", background: `linear-gradient(135deg, ${T.accent} 0%, ${T.gradient2} 100%)`, display: "inline-flex" }}>
                        ...
                        }} {...surfacePress()} style={{ background: T.mode === "light" ? T.surface : "#181614", border: "none", borderRadius: "99px", height: "40px", width: "40px", display: "flex", alignItems: "center", justifyContent: "center", cursor: "pointer", color: T.accent, WebkitTapHighlightColor: "transparent" }}>
                      ...
                      <GhostButton onClick={e => {
                        ...
                        setSetsFilterPos({ top: rect.bottom + 6, right: window.innerWidth - rect.right });
                        setResultsFilterOpen(o => !o);
                      }} style={{ width: "44px", height: "44px", flexShrink: 0, justifyContent: "center", padding: "0" }}>
                        <svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2.5" strokeLinecap="round" strokeLinejoin="round">
                          <polygon points="22 3 2 3 10 12.46 10 19 14 21 14 12.46 22 3"/>
                        </svg>
                      </GhostButton>
      ...
      {sidebarAppearanceOpen ? (
        <div ref={sidebarPopupRef} className="menu-open-up-left" onClick={e => e.stopPropagation()} style={{ ...menuPopupStyle({ position: "fixed", bottom: "3.5rem", left: (sidebarCollapsed ? 4 : 8) + "px", zIndex: 10000, width: SIDEBAR_WIDTH - 16 + "px" }) }}>
          <div style={{ display: "flex", alignItems: "center", padding: "0.75rem 1rem 0.5rem", gap: "0.5rem" }}>
            <button onClick={() => setSidebarAppearanceOpen(false)} style={{ background: "none", border: "none", cursor: "pointer", color: T.muted2, display: "flex", alignItems: "center", padding: "0.25rem", borderRadius: "99px" }}>
              <svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2.5" strokeLinecap="round" strokeLinejoin="round"><polyline points="15 18 9 12 15 6"/></svg>
            </button>
            <p style={{ fontFamily: "'DM Mono', monospace", fontSize: "0.72rem", letterSpacing: "0.12em", color: T.muted2 }}>SETTINGS</p>
          </div>
