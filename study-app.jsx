...
function App() {
  ...
  // Always land at the top of the page when entering a results screen — e.g. right after
  // finishing a quiz, retrying missed questions, or opening a result from History — rather
  // than keeping whatever scroll position the previous screen was left at.
  React.useLayoutEffect(() => {
    if (screen === "results" || screen === "historyResults") {
      window.scrollTo(0, 0);
      document.documentElement.scrollTop = 0;
      document.body.scrollTop = 0;
    }
